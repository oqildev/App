...
（例：${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER}）`,
    ...
    walletPage: {
        ...
        neverSynced: '未同期',
        cardConnectionFixEmployee: '管理者にこの接続の修正を依頼してください',
        cardConnectionFixAdmin: '会社カードでこの接続を修正してください',
        cardConnectionFixPersonal: 'この接続を修正してください',
        fixAction: '修正',
...
${integrationName === CONST.ONBOARDING_ACCOUNTING_MAPPING.other ? 'あなたの' : '宛先'} ${integrationName} を接続して、自動経費コード設定と同期を行い、月末締めをスムーズにしましょう。
    ...
    bankAccount: {
        status: {
            ...
            verifying: '確認中',
            locked: 'ロック中',
            incompleteMessage: '銀行口座の追加を完了してください',
            pendingMessage: 'テスト取引を確認してください',
            lockedMessage: 'このアカウントには対応が必要です',
            verifyingTooltip: '書類を確認しています',
            finishAction: '完了',
            confirmAction: '確認',
            unlockAction: 'ロック解除',
        },
