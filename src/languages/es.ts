...
const translations: TranslationDeepObject<typeof en> = {
    ...
    walletPage: {
        ...
        cardConnectionFixEmployee: 'Pide a un administrador que arregle esta conexión',
        cardConnectionFixAdmin: 'Por favor, arregla esta conexión en Tarjetas de empresa',
        cardConnectionFixPersonal: 'Por favor, arregla esta conexión',
        fixAction: 'Arreglar',
...
${amount} para ${merchant} - ${date}`,
    ...
    bankAccount: {
        status: {
            ...
            locked: 'Bloqueada',
            incompleteMessage: 'Termina de añadir la cuenta bancaria',
            pendingMessage: 'Por favor, confirma las transacciones de prueba',
            lockedMessage: 'Esta cuenta requiere atención',
            verifyingTooltip: 'Estamos revisando tu documentación',
            finishAction: 'Terminar',
