...
(p. ex. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    walletPage: {
        ...
        cardConnectionFixEmployee: 'Veuillez demander à un administrateur de réparer cette connexion',
        cardConnectionFixAdmin: "Veuillez réparer cette connexion dans Cartes d'entreprise",
        cardConnectionFixPersonal: 'Veuillez réparer cette connexion',
        fixAction: 'Réparer',
...
${amount} pour ${merchant} - ${date}`,
    ...
    bankAccount: {
        status: {
            ...
            locked: 'Verrouillé',
            incompleteMessage: "Terminer l'ajout du compte bancaire",
            pendingMessage: 'Veuillez confirmer les transactions de test',
            lockedMessage: 'Ce compte nécessite votre attention',
            verifyingTooltip: 'Nous examinons votre documentation',
