...
(z. B. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    walletPage: {
        ...
        cardConnectionFixEmployee: 'Bitte einen Administrator, diese Verbindung zu reparieren',
        cardConnectionFixAdmin: 'Bitte repariere diese Verbindung in „Firmenkarten"',
        cardConnectionFixPersonal: 'Bitte repariere diese Verbindung',
        fixAction: 'Reparieren',
...
${amount} für ${merchant} – ${date}`,
    ...
    bankAccount: {
        status: {
            ...
            locked: 'Gesperrt',
            incompleteMessage: 'Bankkonto fertig einrichten',
            pendingMessage: 'Bitte Testtransaktionen bestätigen',
            lockedMessage: 'Dieses Konto erfordert Aufmerksamkeit',
            verifyingTooltip: 'Wir prüfen deine Unterlagen',
            finishAction: 'Fertigstellen',
