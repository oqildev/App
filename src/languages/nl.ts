...
(bijv. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    walletPage: {
        ...
        cardConnectionFixEmployee: 'Vraag een beheerder om deze verbinding te herstellen',
        cardConnectionFixAdmin: 'Herstel deze verbinding in Bedrijfskaarten',
        cardConnectionFixPersonal: 'Herstel deze verbinding',
        fixAction: 'Herstellen',
...
${amount} voor ${merchant} - ${date}`,
    ...
    bankAccount: {
        status: {
            ...
            locked: 'Vergrendeld',
            incompleteMessage: 'Voltooi het toevoegen van de bankrekening',
            pendingMessage: 'Bevestig de testtransacties',
            lockedMessage: 'Deze rekening vereist aandacht',
            verifyingTooltip: 'We controleren je documentatie',
            finishAction: 'Voltooien',
