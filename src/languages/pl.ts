...
(np. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    walletPage: {
        ...
        cardConnectionFixEmployee: 'Poproś administratora o naprawę tego połączenia',
        cardConnectionFixAdmin: 'Napraw to połączenie w Kartach firmowych',
        cardConnectionFixPersonal: 'Napraw to połączenie',
        fixAction: 'Napraw',
...
${amount} dla ${merchant} - ${date}`,
    ...
    bankAccount: {
        status: {
            ...
            locked: 'Zablokowane',
            incompleteMessage: 'Dokończ dodawanie konta bankowego',
            pendingMessage: 'Potwierdź transakcje testowe',
            lockedMessage: 'To konto wymaga uwagi',
            verifyingTooltip: 'Sprawdzamy Twoją dokumentację',
            finishAction: 'Zakończ',
