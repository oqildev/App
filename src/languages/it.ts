...
(ad es. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    walletPage: {
        ...
        cardConnectionFixEmployee: 'Chiedi a un amministratore di riparare questa connessione',
        cardConnectionFixAdmin: 'Per favore ripara questa connessione in Carte aziendali',
        cardConnectionFixPersonal: 'Per favore ripara questa connessione',
        fixAction: 'Ripara',
...
${amount} per ${merchant} - ${date}`,
    ...
    bankAccount: {
        status: {
            ...
            locked: 'Bloccato',
            incompleteMessage: "Completa l'aggiunta del conto bancario",
            pendingMessage: 'Conferma le transazioni di prova',
            lockedMessage: 'Questo conto richiede attenzione',
            verifyingTooltip: 'Stiamo esaminando la tua documentazione',
            finishAction: 'Termina',
