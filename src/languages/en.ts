...
const translations = {
    ...
    walletPage: {
        ...
        cardConnectionFixEmployee: 'Please ask an admin to fix this connection',
        cardConnectionFixAdmin: 'Please fix this connection in Company Cards',
        cardConnectionFixPersonal: 'Please fix this connection',
        fixAction: 'Fix',
    ...
    bankAccount: {
        status: {
            ...
            verifying: 'Verifying',
            locked: 'Locked',
            incompleteMessage: 'Finish adding bank account',
            pendingMessage: 'Please confirm test transactions',
            lockedMessage: 'This account requires attention',
            verifyingTooltip: "We're reviewing your documentation",
            finishAction: 'Finish',
