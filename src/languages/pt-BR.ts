...
(p.ex., ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    walletPage: {
        ...
        cardConnectionFixEmployee: 'Peça a um administrador para reparar esta conexão',
        cardConnectionFixAdmin: 'Por favor, repare esta conexão em Cartões da empresa',
        cardConnectionFixPersonal: 'Por favor, repare esta conexão',
        fixAction: 'Reparar',
...
${amount} para ${merchant} - ${date}`,
    ...
    bankAccount: {
        status: {
            ...
            locked: 'Bloqueado',
            incompleteMessage: 'Conclua a adição da conta bancária',
            pendingMessage: 'Confirme as transações de teste',
            lockedMessage: 'Esta conta requer atenção',
            verifyingTooltip: 'Estamos analisando sua documentação',
