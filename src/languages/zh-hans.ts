...
（例如：${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER}）`,
    ...
    walletPage: {
        ...
        neverSynced: '从未同步',
        cardConnectionFixEmployee: '请联系管理员修复此连接',
        cardConnectionFixAdmin: '请在"公司卡"中修复此连接',
        cardConnectionFixPersonal: '请修复此连接',
        fixAction: '修复',
...
${amount}，商户：${merchant} - 日期：${date}`,
    ...
    bankAccount: {
        status: {
            ...
            verifying: '正在验证',
            locked: '已锁定',
            incompleteMessage: '完成添加银行账户',
            pendingMessage: '请确认测试交易',
            lockedMessage: '此账户需要处理',
            verifyingTooltip: '我们正在审核您的文件',
            finishAction: '完成',
            confirmAction: '确认',
            unlockAction: '解锁',
        },
